...
function setup() {
  ...
  trex.setCollider("rectangle",0,0,200,120);
  // trex.debug = true;
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    // if (frameCount%500 === 0){
      ...
      // obstaclesGroup.velocityX = obstaclesGroup.velocityX - 10
      // cloudsGroup.velocityX = cloudsGroup.velocityX - 10;
    //}
